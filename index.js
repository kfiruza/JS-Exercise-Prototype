...
Car.prototype.drive = function(distance) {
  const runOut = this.tank * this.milesPerGallon;
...
/* 
  ...
  1. Window Binding: this will refer back to the parent object of everything, meaning the window or console itself.
